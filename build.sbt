...
ThisBuild / description := "seichi915Network エレベータープラグイン"
...
lazy val root = (project in file("."))
  .settings(
    name := "seichi915Elevator",
    assemblyOutputPath in assembly := baseDirectory.value / "target" / "build" / s"seichi915Elevator-${version.value}.jar"
  )